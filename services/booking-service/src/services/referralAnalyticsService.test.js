    ...
    const bookings = [
      {
        ...
        referral: { code: 'launch-night-1234abcd' },
      ...
      },
      {
        ...
        referral: { code: 'builder-meet-5678efgh' },
